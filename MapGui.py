...
class MicroStrategyMapConfig:
    ...
    # def app1_Exe(self):
    #     MicroStrategy_Web = self.App1ScrolledPath.get()
    #     web_mapconfig_file = Check_web_applications(self, MicroStrategy_Web)
    #     self.App1ScrolledMapLocation.delete(0, END)
    #     self.App1ScrolledMapLocation.insert(END, web_mapconfig_file)
    ...
    def __init__(self, top=None):
        ...
        # self.app1MapFolderStatusLabel = Label(self.Frame1)
        # self.app1MapFolderStatusLabel.place(relx=0.01, rely=0.2, relheight=.05, relwidth=.1)
        # self.app1MapFolderStatusLabel.configure(activebackground="#f9f9f9")
        # self.app1MapFolderStatusLabel.configure(activeforeground="black")
        # self.app1MapFolderStatusLabel.configure(relief="solid")
        # self.app1MapFolderStatusLabel.configure(borderwidth="2")
        # self.app1MapFolderStatusLabel.configure(background="white")
        # self.app1MapFolderStatusLabel.configure(disabledforeground="#a3a3a3")
        # self.app1MapFolderStatusLabel.configure(foreground="#000000")
        # self.app1MapFolderStatusLabel.configure(highlightbackground="black")
        # self.app1MapFolderStatusLabel.configure(highlightcolor="black")
        # self.app1MapFolderStatusLabel.configure(text='''Presence of MapConfig Folder:''')
        #
        # self.app1MapFileStatusLabel = Label(self.Frame1)
        # self.app1MapFileStatusLabel.place(relx=0.01, rely=0.27, relheight=.05, relwidth=.1)
        # self.app1MapFileStatusLabel.configure(activebackground="#f9f9f9")
        # self.app1MapFileStatusLabel.configure(activeforeground="black")
        # self.app1MapFileStatusLabel.configure(background="white")
        # self.app1MapFileStatusLabel.configure(disabledforeground="#a3a3a3")
        # self.app1MapFileStatusLabel.configure(foreground="#000000")
        # self.app1MapFileStatusLabel.configure(highlightbackground="#d9d9d9")
        # self.app1MapFileStatusLabel.configure(highlightcolor="black")
        # self.app1MapFileStatusLabel.configure(text='''Presence of MapConfig.xml:''')
        ...
        # self.App1NewESRI = ScrolledEntry(self.Frame1)
        # self.App1NewESRI.place(relx=0.15, rely=0.63, height=35, relwidth=0.6)
        # self.App1NewESRI.configure(background="white")
        # self.App1NewESRI.configure(disabledforeground="#a3a3a3")
        # self.App1NewESRI.configure(foreground="black")
        # self.App1NewESRI.configure(highlightbackground="#d9d9d9")
        ...
        # self.App1NewGoogle = ScrolledEntry(self.Frame1)
        # self.App1NewGoogle.place(relx=0.15, rely=0.75, height=35, relwidth=0.6)
        # self.App1NewGoogle.configure(background="white")
        # self.App1NewGoogle.configure(disabledforeground="#a3a3a3")
        # self.App1NewGoogle.configure(foreground="black")
        # self.App1NewGoogle.configure(highlightbackground="#d9d9d9")
        ...
        # self.App1NewMapbox = ScrolledEntry(self.Frame1)
        # self.App1NewMapbox.place(relx=0.15, rely=0.87, height=35, relwidth=0.6)
        # self.App1NewMapbox.configure(background="white")
        # self.App1NewMapbox.configure(disabledforeground="#a3a3a3")
        # self.App1NewMapbox.configure(foreground="black")
        # self.App1NewMapbox.configure(highlightbackground="#d9d9d9")
        ...
        # self.App1FileStatus = Label(self.Frame1)
        # self.App1FileStatus.place(relx=0.5, rely=0.3, height=31, width=350)
        # self.App1FileStatus.configure(activebackground="#f9f9f9")
        # self.App1FileStatus.configure(activeforeground="black")
        # self.App1FileStatus.configure(background="#d9d9d9")
        # self.App1FileStatus.configure(disabledforeground="#a3a3a3")
        # self.App1FileStatus.configure(foreground="#000000")
        # self.App1FileStatus.configure(highlightbackground="#d9d9d9")
        # self.App1FileStatus.configure(highlightcolor="black")
        # self.App1FileStatus.configure(text='''''')
        ...
        # self.Label27 = Label(self.Frame1)
        # self.Label27.place(relx=0.01, rely=0.63, height=31, width=81)
        ...
        # self.Label27.configure(text='''New ESRI''')
